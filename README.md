...
relational databases are databases where data is organized in tables that are linked together. sql is the query language to query such databases.
- [ ] Why do tables need a `primary key`?
to access rows 
- [ ] What is the name given to a table column that references the primary key on another table.
a foreign key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
- bridge table + a joint primary key formed from the 2 foreign keys
